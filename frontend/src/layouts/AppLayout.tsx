...
const NAV: Record<Panel, NavGroup[]> = {
  ...
  student: [
    { title: 'Main', items: [{ to: '/student', label: 'Dashboard', icon: LayoutDashboard }] },
    {
      title: 'Academic',
      items: [
    ...
    {
      title: 'Placement',
      items: [{ to: '/student/placements', label: 'Placements', icon: Briefcase }],
    },
  ],
  placement: [
    { title: 'Main', items: [{ to: '/placement', label: 'Dashboard', icon: LayoutDashboard }] },
    {
      ...
      items: [
        ...
        { to: '/placement/placements', label: 'Placements', icon: Briefcase },
      ],
    },
  ],
  alumni: [
