...
export default function StudentPreparationInterview() {
  ...
  if (isLoading) return <Loading label="Loading interview preparation…" />;

  return (
    <div>
      <PageHeader
        title="Interview Preparation"
        subtitle="Master the most common interview questions with curated resources"
      />
